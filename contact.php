...
try {
    ...
    $mail->setFrom('info.iccdaa@gmail.com', 'Contact Submission System');
    $mail->addAddress('info.iccdaa@gmail.com', 'Contact Submissions');
    ...
    $mail->isHTML(true);
    $mail->Subject = 'ICCDAA Contact Submission';
