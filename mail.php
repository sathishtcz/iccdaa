...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info.iccdaa@gmail.com';
    $mail->Password   = 'lyho jfxt fuik ipla';
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    $mail->setFrom('info.iccdaa@gmail.com', 'Paper Submission System');
    $mail->addAddress('info.iccdaa@gmail.com', 'Paper Submissions');
    ...
    $mail->isHTML(true);
    $mail->Subject = 'ICCDAA Paper Submission - ' . htmlspecialchars($_POST['Paper_Title']);
