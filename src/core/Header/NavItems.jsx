...
const NavItems = ({ ToggleMenu, MenuOpen }) => {
    ...
    return (
        <nav
            className={`
                fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-[#E52020] to-[#A40000] transform transition-transform duration-300
        ...
        >
            <div className="p-5">
                ...
                <ul className="flex flex-col mt-12 space-y-4 text-white text-lg roboto-slab-regular">
